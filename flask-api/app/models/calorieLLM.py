...
def calculate_calories(user_id):
    ...
    weightGoals = get_weight_data(user_id)
    if not user_data:
    ...
    response = chain.invoke({
        ...
        "dailyCalorieIntakeMifflin": user_data["dailyCalorieIntakeMifflin"],
        "dailyCalorieIntakeHarrisBenedict": user_data["dailyCalorieIntakeHarrisBenedict"], 
        "dailyCalorieIntakeKatchMcArdle": user_data["dailyCalorieIntakeKatchMcArdle"]
    })
